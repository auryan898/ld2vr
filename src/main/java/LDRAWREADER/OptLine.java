// $Id: OptLine.java 1.3 1999/05/19 20:23:35 parisjp Exp $
...
public class OptLine extends AbstLine {
   public OptLine() {
   };

   public OptLine(OptLine v) {
      colorValue_ = v.colorValue_;
      x1_ = v.x1_; y1_ = v.y1_; z1_ = v.z1_;
      x2_ = v.x2_; y2_ = v.y2_; z2_ = v.z2_;
      x3_ = v.x3_; y3_ = v.y3_; z3_ = v.z3_;
      x4_ = v.x4_; y4_ = v.y4_; z4_ = v.z4_;
   };

   public OptLine parse(LdrawReader r) throws java.io.IOException {
      ...
      x4_ = r.readDouble(); y4_ = r.readDouble(); z4_ = r.readDouble();
      r.readEol();
   ...
   public String toString(String p1, String p2, String p3, String p4) {
      return "5 " + colorValue_ + " " + p1 + " " + p2 + " " + p3 + " " + p4;
   };
   ...
   public final double x4() { return x4_; };
   public final double y4() { return y4_; };
   public final double z4() { return z4_; };
