...
public class Quadrilateral extends AbstLine {
   ...
   public void swap23() {
      double tmp = x2_; x2_ = x3_; x3_ = tmp;
      tmp = y2_; y2_ = y3_; y3_ = tmp;
      tmp = z2_; z2_ = z3_; z3_ = tmp;
   };
   public void swap34() {
      double tmp = x3_; x3_ = x4_; x4_ = tmp;
      tmp = y3_; y3_ = y4_; y4_ = tmp;
      tmp = z3_; z3_ = z4_; z4_ = tmp;
   };
