...
/**
 * This class is the root of all the VRML2 nodes hierarchy. Each class
 * associated with a VRML97 node is generated using the GENERATOR package. These
 * classes map all the fields of the associated node to a 'set_...' method. For
 * example, you can write:
 * <pre>
 * Viewpoint v = new Viewpoint()
 *    .set_description(new SFString("Front"))
 *    .set_position(0, 0, .1));
 * </pre> Then, to print the VRML code:
 * <pre>
...
public abstract class VRML2Node {
    ...
    /**
     * Returns a string representation of a node according to an indentation
     * level.
     *
    ...
    /**
     * The number of characters added for one indentation level. May be set to
     * zero to get no indentation at all.
     */
