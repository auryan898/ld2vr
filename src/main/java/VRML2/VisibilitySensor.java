...
public class VisibilitySensor extends NamedNode {
   public VisibilitySensor( ) {
      super();
   }
   public VisibilitySensor(String val) {
      super(val);
   }
   public VisibilitySensor(boolean val) {
      super(val);
   }

   public final VisibilitySensor set_center(SFVec3f val) {
      center_ = val;
      return this;
   };
   public final VisibilitySensor set_center(double val0,double val1,double val2) {
      center_ = new SFVec3f(val0,val1,val2);
      return this;
   };
   public final VisibilitySensor set_center(String alias) {
      center_ = new Alias(alias);
      return this;
   };
   public final VisibilitySensor set_enabled(SFBool val) {
      enabled_ = val;
      return this;
   };
   public final VisibilitySensor set_enabled(boolean val0) {
      enabled_ = new SFBool(val0);
      return this;
   };
   public final VisibilitySensor set_enabled(String alias) {
      enabled_ = new Alias(alias);
      return this;
   };
   public final VisibilitySensor set_size(SFVec3f val) {
      size_ = val;
      return this;
   };
   public final VisibilitySensor set_size(double val0,double val1,double val2) {
      size_ = new SFVec3f(val0,val1,val2);
      return this;
   };
   public final VisibilitySensor set_size(String alias) {
      size_ = new Alias(alias);
      return this;
   };

   public String codeStringAux(int l) {
      StringBuffer sb = new StringBuffer("VisibilitySensor {\n");
