...
public class NormalInterpolator extends NamedNode {
   public NormalInterpolator( ) {
      super();
   }
   public NormalInterpolator(String val) {
      super(val);
   }
   public NormalInterpolator(boolean val) {
      super(val);
   }
   ...
   public final NormalInterpolator set_key(MFFloat val) {
      key_ = val;
      return this;
   };
   public final NormalInterpolator set_key(String alias) {
   ...
   public final NormalInterpolator set_keyValue(MFVec3f val) {
      keyValue_ = val;
      return this;
   };
   public final NormalInterpolator set_keyValue(String alias) {
      keyValue_ = new Alias(alias);
      return this;
   };

   public String codeStringAux(int l) {
      StringBuffer sb = new StringBuffer("NormalInterpolator {\n");
