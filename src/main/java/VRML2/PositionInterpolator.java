...
public class PositionInterpolator extends NamedNode {
   public PositionInterpolator( ) {
      super();
   }
   public PositionInterpolator(String val) {
      super(val);
   }
   public PositionInterpolator(boolean val) {
      super(val);
   }
   ...
   public final PositionInterpolator set_key(MFFloat val) {
      key_ = val;
      return this;
   };
   public final PositionInterpolator set_key(String alias) {
   ...
   public final PositionInterpolator set_keyValue(MFVec3f val) {
      keyValue_ = val;
      return this;
   };
   public final PositionInterpolator set_keyValue(String alias) {
      keyValue_ = new Alias(alias);
      return this;
   };

   public String codeStringAux(int l) {
      StringBuffer sb = new StringBuffer("PositionInterpolator {\n");
